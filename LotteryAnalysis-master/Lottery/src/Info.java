...
public class Info extends LotteryFE{
    ...
    private int num_of_combinations;
    private Frequency frq[];
    
    public Frequency[] getFrq() {
        return frq;
    }

    public void setFrq(Frequency[] frq) {
        this.frq = frq;
    }

    public int getNum_of_combinations() {
        return num_of_combinations;
    }

    public void setNum_of_combinations(int num_of_combinations) {
        this.num_of_combinations = num_of_combinations;
    }
    ...
    public boolean isCan_repeat() {
        return can_repeat;
    }

    public void setCan_repeat(boolean can_repeat) {
    ...
    public Info(int start, int end, int total, boolean show_combination_no, int combination_number, boolean print_to_file, Numbers number, boolean can_repeat) throws FileNotFoundException, UnsupportedEncodingException {
        this.start = start;
        this.end = end;
        this.total = total;
        this.show_combination_no = show_combination_no;
        ...
        this.can_repeat = can_repeat;
        this.frq = new Frequency[end - start + 1];
    }
}
